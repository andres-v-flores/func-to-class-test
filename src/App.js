...
function App() {
    ...
    const submitToDataBase = async (obj) => {
        ...
        async function fetchPost(obj) {
            ...
            if (!response.ok) {
                throw new Error(
                    "Something went wrong with posting to database"
                );
            } // if error throw erro
            const data = await response.json();
    ...
    const fetchTask = useCallback(async () => {
        async function fetchGet() {
            ...
            if (!response.ok) {
                throw new Error(
                    "Something went wrong with fetching from database"
                );
            }
            const data = await response.json();
            //console.log(data);
        ...
        try {
            // try to fetch data then update state to display item
    ...
    const deleteTask = async (taskId) => {
        ...
        async function fetchDel() {
            ...
            if (!response.ok) {
                throw new Error(
                    "Something went wrong when deleting data from data base"
                );
            }
